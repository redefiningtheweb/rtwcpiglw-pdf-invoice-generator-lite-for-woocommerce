...
<table class="wp-list-table form-table rtw-table">
	<tr>
		...
		<td class="descr_2">
			...
			<?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_enable_shpng_lbl_text_watermark'])) { echo esc_html('checked = "checked"'); } ?> />
...
<tr>
	...
	<td class="descr_2">
		...
		<?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_enable_shpng_lbl_image_watermark'])) { echo esc_html('checked = "checked"'); } ?> />
