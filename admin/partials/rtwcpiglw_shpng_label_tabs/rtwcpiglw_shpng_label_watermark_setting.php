...
<table class="wp-list-table form-table rtw-table">
	<tr>
		...
		<td class="descr_2">
			...
			<?php checked( $rtwcpiglw_get_setting['rtwcpiglw_enable_shpng_lbl_text_watermark'], 1 ); ?> />
...
<tr>
	...
	<td class="descr_2">
		...
		<?php checked( $rtwcpiglw_get_setting['rtwcpiglw_enable_shpng_lbl_image_watermark'], 1 ); ?> />
